...
DeviceSorter::DeviceSorter(const myvk::Ptr<myvk::Device> &pDevice, const Config &config) : mConfig{config} {
	auto pDescriptorSetLayout = myvk::DescriptorSetLayout::Create( //
	    ...
	    std::vector<VkDescriptorSetLayoutBinding>{
	        {.binding = UBUF_KEY_COUNT_BINDING,
	        ...
	        {.binding = SBUF_DISPATCH_ARGS_BINDING,
	         ...
	         .descriptorCount = 1u,
	         .stageFlags = VK_SHADER_STAGE_COMPUTE_BIT},
	        {.binding = SBUF_GLOBAL_HISTS_BINDING,
	         .descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
	         .descriptorCount = 1u,
	         .stageFlags = VK_SHADER_STAGE_COMPUTE_BIT},
	        {.binding = SBUF_PASS_HISTS_BINDING,
	         .descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
	         .descriptorCount = 1u,
	         .stageFlags = VK_SHADER_STAGE_COMPUTE_BIT},
	        {.binding = SBUF_INDICES_BINDING,
	         .descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
	         .descriptorCount = 1u,
	         .stageFlags = VK_SHADER_STAGE_COMPUTE_BIT},
	        {.binding = SBUF_SRC_KEYS_BINDING,
	         .descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
	         .descriptorCount = 1u,
	         .stageFlags = VK_SHADER_STAGE_COMPUTE_BIT},
	        {.binding = SBUF_SRC_PAYLOADS_BINDING,
	         .descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
	         .descriptorCount = 1u,
	         .stageFlags = VK_SHADER_STAGE_COMPUTE_BIT},
	        {.binding = SBUF_DST_KEYS_BINDING,
	         .descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
	         .descriptorCount = 1u,
	         .stageFlags = VK_SHADER_STAGE_COMPUTE_BIT},
	        {.binding = SBUF_DST_PAYLOADS_BINDING,
	         .descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
	         .descriptorCount = 1u,
	         .stageFlags = VK_SHADER_STAGE_COMPUTE_BIT},
	    },
...
void DeviceSorter::CmdSort(const myvk::Ptr<myvk::CommandBuffer> &pCommandBuffer, const ROArgs &roArgs,
	...
	pCommandBuffer->CmdPushDescriptorSet(
	    ...
	    {
	        myvk::DescriptorSetWrite::WriteUniformBuffer(nullptr, roArgs.pCountBuffer, UBUF_KEY_COUNT_BINDING),
	        myvk::DescriptorSetWrite::WriteStorageBuffer(nullptr, resource.pDispatchArgBuffer, SBUF_DISPATCH_ARGS_BINDING),
	        myvk::DescriptorSetWrite::WriteStorageBuffer(nullptr, resource.pGlobalHistBuffer, SBUF_GLOBAL_HISTS_BINDING),
	        myvk::DescriptorSetWrite::WriteStorageBuffer(nullptr, resource.pPassHistBuffer, SBUF_PASS_HISTS_BINDING),
	        myvk::DescriptorSetWrite::WriteStorageBuffer(nullptr, resource.pIndexBuffer, SBUF_INDICES_BINDING),
	        myvk::DescriptorSetWrite::WriteStorageBuffer(nullptr, pSrcKeyBuffer, SBUF_SRC_KEYS_BINDING),
	        myvk::DescriptorSetWrite::WriteStorageBuffer(nullptr, pSrcPayloadBuffer, SBUF_SRC_PAYLOADS_BINDING),
	        myvk::DescriptorSetWrite::WriteStorageBuffer(nullptr, pDstKeyBuffer, SBUF_DST_KEYS_BINDING),
	        myvk::DescriptorSetWrite::WriteStorageBuffer(nullptr, pDstPayloadBuffer, SBUF_DST_PAYLOADS_BINDING),
	    });
